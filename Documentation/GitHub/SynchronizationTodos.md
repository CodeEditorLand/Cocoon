...
This document tracks the coordination points between Cocoon (extension host),
Wind (frontend), and Mountain (backend) implementations.
...
2. **Extension Management**: Mountain needs to handle extension scanning and
   loading
