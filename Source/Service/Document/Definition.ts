 ...
 * Responsibilities:
 *   - Manages the lifecycle of text documents (add, remove, change).
 *   - Provides the public `vscode.workspace` API related to documents.
 *   - Manages registration and invocation of `TextDocumentContentProvider`s.
 *   - Acts as the extension host-side counterpart to `MainThreadDocuments` in Mountain.
 */
