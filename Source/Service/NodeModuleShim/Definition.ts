/*
 * File: Cocoon/Source/Service/NodeModuleShim/Definition.ts
 *
 * This file contains the live implementation of the `NodeModuleShim` service, which
...
export default Effect.gen(function* (G) {
	...
	const NodeModuleShim: NodeModuleShimService = {
		Load(
			Request: string,
			ParentURI?: Uri,
