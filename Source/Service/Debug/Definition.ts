 ...
 *
 * This file contains the live implementation of the Debug service.
 */
...
export default Effect.gen(function* (G) {
	...
	const ServiceImplementation: Service["Type"] = {
		...
		// Stubbed
		StopDebugging: (_session?: DebugSession) => Effect.void,
		// Stubbed
		AddBreakpoints: (_breakpoints: readonly Breakpoint[]) => Effect.void,
		// Stubbed
		RemoveBreakpoints: (_breakpoints: readonly Breakpoint[]) => Effect.void,
	};
