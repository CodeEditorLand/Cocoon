/**
 * @module ProcessShim (NodeModuleShim/Shim)
 ...
 */
const CreateSanitizedEnv = (): { [key: string]: string | undefined } => {
	const SanitizedEnv: { [key: string]: string | undefined } = {};
	...
	return Object.freeze(SanitizedEnv); // Freeze the final object
};
