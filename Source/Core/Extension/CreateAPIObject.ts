 ...
 *
 * This file contains a factory function that creates the public-facing `vscode.Extension`
 * object. It acts as an adapter between the internal extension host service and the
