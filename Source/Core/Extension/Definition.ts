/*
 * File: Cocoon/Source/Core/Extension/Definition.ts
 *
 * This file contains the live implementation of the Extension service, which corresponds
 * to the `vscode.extensions` API namespace.
 */
