 ...
 * Responsibility: Provides the ProcessPatch service entry point for Cocoon's Node.js sidecar, exposing native process patching functions and configuration to enable VS Code extension compatibility within the Node.js environment.
 * Modified: 2025-06-17 11:20:57 UTC
