	...
	implements ExtHostTerminalServiceShape
{
	...
	public createTerminal(
		...
		if (typeof nameOrOptions === "string") {
			terminalOptions = { name: nameOrOptions, shellPath, shellArgument };
		} else {
