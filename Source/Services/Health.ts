...
export class HealthService implements IHealthService {
    ...
    private async initializeCoreServices(): Promise<void> {
        ...
        for (const service of coreServices) {
            ...
            console.log(`[HealthService] Initialized monitoring for service: ${service.name}`);
        }

        console.log(`[HealthService] Initialized ${this.monitoredServices.size} core services`);
    }
    ...
    private async checkServiceHeartbeats(): Promise<void> {
        ...
        for (const [serviceName, serviceHealth] of this.monitoredServices.entries()) {
     ...
     */
    private async checkServiceHealth(serviceName: string, serviceHealth: ServiceHealth): Promise<void> {
        try {
            ...
            serviceHealth.status = isHealthy ? HealthStatus.HEALTHY : HealthStatus.UNHEALTHY;
            ...
            console.log(`[HealthService] Service ${serviceName} health check: ${serviceHealth.status}`);
        } catch (error) {
