...
export function loadMountainConfigFromEnv(): MountainConfig {
    ...
    if (process.env.MOUNTAIN_MAX_AUTO_RECONNECT_ATTEMPTS) {
        const attempts = parseInt(process.env.MOUNTAIN_MAX_AUTO_RECONNECT_ATTEMPTS, 10);
 ...
 */
export function createMountainConfig(overrides?: Partial<MountainConfig>): MountainConfig {
