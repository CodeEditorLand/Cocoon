...
console.error(
	...
	"[Cocoon FS Module Factory - OBSOLETE] WARNING: This module  is OBSOLETE and should be removed. " +
		"Its corresponding shim  relies on a deprecated and non-functional backend in Mountain. " +
