  ...
  try {
    ...
    try {
      ...
      return {
        Success: false,
        Message: null,
        Error: `Failed to parse batch metadata JSON: ${Error2 instanceof Error2 ? Error2.message : String(Error2)}`,
        Warnings,
        Messages: []
      };
    }
...
export {
  UnbatchMessages_default as default
};
//# sourceMappingURL=UnbatchMessages.js.map
