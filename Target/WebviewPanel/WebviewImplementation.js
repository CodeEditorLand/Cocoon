...
__name2(setUnexpectedErrorHandler, "setUnexpectedErrorHandler");
...
__name2(isSigPipeError, "isSigPipeError");
function onBugIndicatingError(e) {
  errorHandler.onUnexpectedError(e);
  return void 0;
}
__name(onBugIndicatingError, "onBugIndicatingError");
__name2(onBugIndicatingError, "onBugIndicatingError");
...
__name2(onUnexpectedError, "onUnexpectedError");
...
__name2(onUnexpectedExternalError, "onUnexpectedExternalError");
...
__name2(transformErrorForSerialization, "transformErrorForSerialization");
...
__name2(transformErrorFromSerialization, "transformErrorFromSerialization");
...
__name2(isCancellationError, "isCancellationError");
var CancellationError = class extends Error {
  static {
    __name(this, "CancellationError");
  }
  static {
    __name2(this, "CancellationError");
  }
  constructor() {
    super(canceledName);
...
var PendingMigrationError = class _PendingMigrationError extends Error {
  ...
  static {
    __name2(this, "PendingMigrationError");
  }
  static {
...
__name2(illegalArgument, "illegalArgument");
...
var NotImplementedError = class extends Error {
  ...
  static {
    __name2(this, "NotImplementedError");
  }
  constructor(message) {
...
var NotSupportedError = class extends Error {
  ...
  static {
    __name2(this, "NotSupportedError");
  }
  constructor(message) {
    super("NotSupported");
    if (message) {
...
var BugIndicatingError = class _BugIndicatingError extends Error {
  ...
  static {
    __name2(this, "BugIndicatingError");
  }
  constructor(message) {
...
__name3(getNLSMessages, "getNLSMessages");
function getNLSLanguage() {
  return globalThis._VSCODE_NLS_LANGUAGE;
}
__name(getNLSLanguage, "getNLSLanguage");
__name3(getNLSLanguage, "getNLSLanguage");
...
__name3(lookupMessage, "lookupMessage");
...
__name4(PlatformToString, "PlatformToString");
var _platform = 0;
if (_isMacintosh) {
  _platform = 1;
} else if (_isWindows) {
...
(function(Language2) {
  ...
  __name4(isDefaultVariant, "isDefaultVariant");
  Language2.isDefaultVariant = isDefaultVariant;
  function isDefault() {
    return language === "en";
  }
  __name(isDefault, "isDefault");
  __name4(isDefault, "isDefault");
...
__name4(isLittleEndian, "isLittleEndian");
...
__name4(isTahoeOrNewer, "isTahoeOrNewer");
...
__name7(findLastIdx, "findLastIdx");
...
__name7(findFirstIdx, "findFirstIdx");
function findLastMonotonous(array, predicate) {
  const idx = findLastIdxMonotonous(array, predicate);
  return idx === -1 ? void 0 : array[idx];
}
__name(findLastMonotonous, "findLastMonotonous");
__name7(findLastMonotonous, "findLastMonotonous");
...
__name7(findFirstIdxMonotonousOrArrLen, "findFirstIdxMonotonousOrArrLen");
...
__name7(findFirstIdxMonotonous, "findFirstIdxMonotonous");
var MonotonousArray = class _MonotonousArray {
  static {
    __name(this, "MonotonousArray");
  }
  static {
    __name7(this, "MonotonousArray");
  }
  static {
...
__name7(findFirstMax, "findFirstMax");
...
__name7(mapFindFirst, "mapFindFirst");
...
var numberComparator = /* @__PURE__ */ __name8((a, b) => a - b, "numberComparator");
var booleanComparator = /* @__PURE__ */ __name8((a, b) => numberComparator(a ? 1 : 0, b ? 1 : 0), "booleanComparator");
...
__name9(mapToString, "mapToString");
...
__name9(setToString, "setToString");
var ResourceMapEntry = class {
  static {
    __name(this, "ResourceMapEntry");
  }
  static {
    __name9(this, "ResourceMapEntry");
  }
...
__name9(mapsStrictEqualIgnoreOrder, "mapsStrictEqualIgnoreOrder");
var NKeyMap = class {
  static {
    __name(this, "NKeyMap");
  }
  static {
    __name9(this, "NKeyMap");
  }
  constructor() {
  ...
  *values() {
   ...
   */
  toString() {
    const printMap = /* @__PURE__ */ __name9((map, depth) => {
      let result = "";
...
__name10(assertNever, "assertNever");
function softAssertNever(value) {
}
__name(softAssertNever, "softAssertNever");
__name10(softAssertNever, "softAssertNever");
...
__name10(softAssert, "softAssert");
...
__name10(checkAdjacentItems, "checkAdjacentItems");
...
__name11(isString, "isString");
function isStringArray(value) {
  return isArrayOf(value, isString);
}
__name(isStringArray, "isStringArray");
__name11(isStringArray, "isStringArray");
function isArrayOf(value, check) {
  return Array.isArray(value) && value.every(check);
}
__name(isArrayOf, "isArrayOf");
__name11(isArrayOf, "isArrayOf");
function isObject(obj) {
  return typeof obj === "object" && obj !== null && !Array.isArray(obj) && !(obj instanceof RegExp) && !(obj instanceof Date);
}
__name(isObject, "isObject");
__name11(isObject, "isObject");
function isTypedArray(obj) {
  const TypedArray = Object.getPrototypeOf(Uint8Array);
  return typeof obj === "object" && obj instanceof TypedArray;
}
__name(isTypedArray, "isTypedArray");
__name11(isTypedArray, "isTypedArray");
function isNumber(obj) {
  return typeof obj === "number" && !isNaN(obj);
}
__name(isNumber, "isNumber");
__name11(isNumber, "isNumber");
function isIterable(obj) {
  return !!obj && typeof obj[Symbol.iterator] === "function";
}
__name(isIterable, "isIterable");
__name11(isIterable, "isIterable");
function isAsyncIterable(obj) {
  return !!obj && typeof obj[Symbol.asyncIterator] === "function";
}
__name(isAsyncIterable, "isAsyncIterable");
__name11(isAsyncIterable, "isAsyncIterable");
function isBoolean(obj) {
  return obj === true || obj === false;
}
__name(isBoolean, "isBoolean");
__name11(isBoolean, "isBoolean");
function isUndefined(obj) {
  return typeof obj === "undefined";
}
__name(isUndefined, "isUndefined");
__name11(isUndefined, "isUndefined");
function isDefined(arg) {
  return !isUndefinedOrNull(arg);
}
__name(isDefined, "isDefined");
__name11(isDefined, "isDefined");
function isUndefinedOrNull(obj) {
  return isUndefined(obj) || obj === null;
}
__name(isUndefinedOrNull, "isUndefinedOrNull");
__name11(isUndefinedOrNull, "isUndefinedOrNull");
...
__name11(assertType, "assertType");
...
__name11(assertReturnsDefined, "assertReturnsDefined");
...
__name11(assertDefined, "assertDefined");
...
__name11(assertReturnsAllDefined, "assertReturnsAllDefined");
var isOneOf = /* @__PURE__ */ __name11((value, validValues) => {
  return validValues.includes(value);
}, "isOneOf");
function typeCheck(_thing) {
}
__name(typeCheck, "typeCheck");
__name11(typeCheck, "typeCheck");
...
__name11(isEmptyObject, "isEmptyObject");
...
__name11(areFunctions, "areFunctions");
...
__name11(validateConstraints, "validateConstraints");
...
__name11(validateConstraint, "validateConstraint");
function upcast(x) {
  return x;
}
__name(upcast, "upcast");
__name11(upcast, "upcast");
...
(function(Iterable2) {
  ...
  __name(empty, "empty");
  __name12(empty, "empty");
  Iterable2.empty = empty;
  function* single(element) {
    yield element;
  }
  __name(single, "single");
  __name12(single, "single");
  ...
  __name12(reverse, "reverse");
  Iterable2.reverse = reverse;
  function isEmpty(iterable) {
    return !iterable || iterable[Symbol.iterator]().next().done === true;
  }
  __name(isEmpty, "isEmpty");
  __name12(isEmpty, "isEmpty");
  Iterable2.isEmpty = isEmpty;
  function first(iterable) {
    return iterable[Symbol.iterator]().next().value;
  }
  __name(first, "first");
  __name12(first, "first");
  ...
  __name12(asyncToArray, "asyncToArray");
  ...
  __name12(asyncToArrayFlat, "asyncToArrayFlat");
...
var GCBasedDisposableTracker = class {
  ...
  static {
    __name13(this, "GCBasedDisposableTracker");
  }
  constructor() {
...
var DisposableTracker = class _DisposableTracker {
  ...
  static {
    __name13(this, "DisposableTracker");
  }
  constructor() {
  ...
  computeLeakingDisposables(maxReported = 10, preComputedLeaks) {
    ...
    function getStackTracePath(leaking) {
      ...
      __name13(removePrefix, "removePrefix");
      const lines = leaking.source.split("\n").map((p) => p.trim().replace("at ", "")).filter((l) => l !== "");
      removePrefix(lines, ["Error", /^trackDisposable \(.*\)$/, /^DisposableTracker.trackDisposable \(.*\)$/]);
      return lines.reverse();
    }
    __name(getStackTracePath, "getStackTracePath");
    __name13(getStackTracePath, "getStackTracePath");
...
__name13(setDisposableTracker, "setDisposableTracker");
...
__name13(trackDisposable, "trackDisposable");
function markAsDisposed(disposable) {
  disposableTracker?.markAsDisposed(disposable);
}
__name(markAsDisposed, "markAsDisposed");
__name13(markAsDisposed, "markAsDisposed");
function setParentOfDisposable(child, parent) {
  disposableTracker?.setParent(child, parent);
}
__name(setParentOfDisposable, "setParentOfDisposable");
__name13(setParentOfDisposable, "setParentOfDisposable");
...
__name13(setParentOfDisposables, "setParentOfDisposables");
function markAsSingleton(singleton) {
  disposableTracker?.markAsSingleton(singleton);
  return singleton;
}
__name(markAsSingleton, "markAsSingleton");
__name13(markAsSingleton, "markAsSingleton");
function isDisposable(thing) {
  return typeof thing === "object" && thing !== null && typeof thing.dispose === "function" && thing.dispose.length === 0;
}
__name(isDisposable, "isDisposable");
__name13(isDisposable, "isDisposable");
...
__name13(disposeIfDisposable, "disposeIfDisposable");
...
__name13(combinedDisposable, "combinedDisposable");
var FunctionDisposable = class {
  static {
    __name(this, "FunctionDisposable");
  }
  static {
    __name13(this, "FunctionDisposable");
  }
  constructor(fn) {
...
__name13(toDisposable, "toDisposable");
var DisposableStore = class _DisposableStore {
  static {
    __name(this, "DisposableStore");
  }
  static {
    __name13(this, "DisposableStore");
  }
  static {
...
var MutableDisposable = class {
  ...
  static {
    __name13(this, "MutableDisposable");
  }
  constructor() {
    this._isDisposed = false;
    trackDisposable(this);
...
var MandatoryMutableDisposable = class {
  ...
  static {
    __name13(this, "MandatoryMutableDisposable");
  }
...
var RefCountedDisposable = class {
  ...
  static {
    __name13(this, "RefCountedDisposable");
  }
...
var ReferenceCollection = class {
  ...
  static {
    __name13(this, "ReferenceCollection");
  }
  constructor() {
...
var AsyncReferenceCollection = class {
  ...
  static {
    __name13(this, "AsyncReferenceCollection");
  }
  ...
  async acquire(key, ...args) {
    ...
    try {
      ...
      return {
        object,
        dispose: /* @__PURE__ */ __name13(() => ref.dispose(), "dispose")
      };
    } catch (error) {
      ref.dispose();
      throw error;
...
var ImmortalReference = class {
  ...
  static {
    __name13(this, "ImmortalReference");
  }
  constructor(object) {
    this.object = object;
  }
...
__name13(disposeOnReturn, "disposeOnReturn");
var DisposableMap = class {
  static {
    __name(this, "DisposableMap");
  }
  static {
    __name13(this, "DisposableMap");
  }
...
__name13(thenIfNotDisposed, "thenIfNotDisposed");
...
__name13(thenRegisterOrDispose, "thenRegisterOrDispose");
var DisposableResourceMap = class extends DisposableMap {
  static {
    __name(this, "DisposableResourceMap");
  }
  static {
    __name13(this, "DisposableResourceMap");
  }
  constructor() {
...
__name18(identity, "identity");
var LRUCachedFunction = class {
  static {
    __name(this, "LRUCachedFunction");
  }
  static {
    __name18(this, "LRUCachedFunction");
  }
...
var WeakCachedFunction = class {
  ...
  static {
    __name18(this, "WeakCachedFunction");
  }
  constructor(arg1, arg2) {
...
__name20(isFalsyOrWhitespace, "isFalsyOrWhitespace");
...
__name20(htmlAttributeEncodeValue, "htmlAttributeEncodeValue");
...
__name20(escape, "escape");
function escapeRegExpCharacters(value) {
  return value.replace(/[\\\{\}\*\+\?\|\^\$\.\[\]\(\)]/g, "\\$&");
}
__name(escapeRegExpCharacters, "escapeRegExpCharacters");
__name20(escapeRegExpCharacters, "escapeRegExpCharacters");
...
__name20(truncateMiddle, "truncateMiddle");
...
__name(rtrim, "rtrim");
__name20(rtrim, "rtrim");
function convertSimple2RegExpPattern(pattern) {
  return pattern.replace(/[\-\\\{\}\+\?\|\^\$\.\,\[\]\(\)\#\s]/g, "\\$&").replace(/[\*]/g, ".*");
}
__name(convertSimple2RegExpPattern, "convertSimple2RegExpPattern");
__name20(convertSimple2RegExpPattern, "convertSimple2RegExpPattern");
...
__name20(createRegExp, "createRegExp");
...
__name20(regExpLeadsToEndlessLoop, "regExpLeadsToEndlessLoop");
...
__name20(joinStrings, "joinStrings");
function splitLines(str) {
  return str.split(/\r\n|\r|\n/);
}
__name(splitLines, "splitLines");
__name20(splitLines, "splitLines");
...
__name20(splitLinesIncludeSeparators, "splitLinesIncludeSeparators");
...
__name20(indexOfPattern, "indexOfPattern");
...
__name20(firstNonWhitespaceIndex, "firstNonWhitespaceIndex");
...
__name20(getLeadingWhitespace, "getLeadingWhitespace");
...
__name20(lastNonWhitespaceIndex, "lastNonWhitespaceIndex");
...
__name20(getIndentationLength, "getIndentationLength");
...
__name20(replaceAsync, "replaceAsync");
...
__name20(compareSubstring, "compareSubstring");
function compareIgnoreCase(a, b) {
  return compareSubstringIgnoreCase(a, b, 0, a.length, 0, b.length);
}
__name(compareIgnoreCase, "compareIgnoreCase");
__name20(compareIgnoreCase, "compareIgnoreCase");
...
__name20(startsWithIgnoreCase, "startsWithIgnoreCase");
...
__name20(endsWithIgnoreCase, "endsWithIgnoreCase");
...
__name20(commonPrefixLength2, "commonPrefixLength");
...
__name20(commonSuffixLength, "commonSuffixLength");
function isHighSurrogate(charCode) {
  return 55296 <= charCode && charCode <= 56319;
}
__name(isHighSurrogate, "isHighSurrogate");
__name20(isHighSurrogate, "isHighSurrogate");
function isLowSurrogate(charCode) {
  return 56320 <= charCode && charCode <= 57343;
}
__name(isLowSurrogate, "isLowSurrogate");
__name20(isLowSurrogate, "isLowSurrogate");
function computeCodePoint(highSurrogate, lowSurrogate) {
  return (highSurrogate - 55296 << 10) + (lowSurrogate - 56320) + 65536;
}
__name(computeCodePoint, "computeCodePoint");
__name20(computeCodePoint, "computeCodePoint");
...
__name20(getNextCodePoint, "getNextCodePoint");
...
__name20(getPrevCodePoint, "getPrevCodePoint");
var CodePointIterator = class {
  static {
    __name(this, "CodePointIterator");
  }
  static {
    __name20(this, "CodePointIterator");
  }
  get offset() {
    return this._offset;
  }
...
var GraphemeIterator = class {
  ...
  static {
    __name20(this, "GraphemeIterator");
  }
  get offset() {
...
__name20(nextCharLength, "nextCharLength");
function prevCharLength(str, initialOffset) {
  const iterator = new GraphemeIterator(str, initialOffset);
  return iterator.prevGraphemeLength();
}
__name(prevCharLength, "prevCharLength");
__name20(prevCharLength, "prevCharLength");
...
__name20(getCharContainingOffset, "getCharContainingOffset");
...
__name20(isFullWidthCharacter, "isFullWidthCharacter");
...
__name20(isEmojiImprecise, "isEmojiImprecise");
...
__name20(forAnsiStringParts, "forAnsiStringParts");
...
__name20(removeAnsiEscapeCodes, "removeAnsiEscapeCodes");
...
__name20(removeAnsiEscapeCodesFromPrompt, "removeAnsiEscapeCodesFromPrompt");
...
__name20(startsWithUTF8BOM, "startsWithUTF8BOM");
function stripUTF8BOM(str) {
  return startsWithUTF8BOM(str) ? str.substr(1) : str;
}
__name(stripUTF8BOM, "stripUTF8BOM");
__name20(stripUTF8BOM, "stripUTF8BOM");
...
__name20(fuzzyContains, "fuzzyContains");
...
__name20(containsUppercaseCharacter, "containsUppercaseCharacter");
function uppercaseFirstLetter(str) {
  return str.charAt(0).toUpperCase() + str.slice(1);
}
__name(uppercaseFirstLetter, "uppercaseFirstLetter");
__name20(uppercaseFirstLetter, "uppercaseFirstLetter");
...
__name20(singleLetterHash, "singleLetterHash");
function getGraphemeBreakType(codePoint) {
  const graphemeBreakTree = GraphemeBreakTree.getInstance();
  return graphemeBreakTree.getGraphemeBreakType(codePoint);
}
__name(getGraphemeBreakType, "getGraphemeBreakType");
__name20(getGraphemeBreakType, "getGraphemeBreakType");
...
__name20(breakBetweenGraphemeBreakType, "breakBetweenGraphemeBreakType");
...
var GraphemeBreakTree = class _GraphemeBreakTree {
  ...
  static {
    __name20(this, "GraphemeBreakTree");
  }
  static {
    this._INSTANCE = null;
  }
...
__name20(getGraphemeBreakRawData, "getGraphemeBreakRawData");
...
__name20(getLeftDeleteOffset, "getLeftDeleteOffset");
...
__name20(getOffsetBeforeLastEmojiComponent, "getOffsetBeforeLastEmojiComponent");
function isEmojiModifier(codePoint) {
  return 127995 <= codePoint && codePoint <= 127999;
}
__name(isEmojiModifier, "isEmojiModifier");
__name20(isEmojiModifier, "isEmojiModifier");
var CodePoint;
(function(CodePoint2) {
...
var AmbiguousCharacters = class _AmbiguousCharacters {
  ...
  static {
    __name20(this, "AmbiguousCharacters");
  }
  static {
  ...
  static {
    this.cache = new LRUCachedFunction((localesStr) => {
      ...
      __name20(arrayToMap, "arrayToMap");
      ...
      __name20(intersectMaps, "intersectMaps");
...
var InvisibleCharacters = class _InvisibleCharacters {
  ...
  static {
    __name20(this, "InvisibleCharacters");
  }
  static getRawData() {
...
var ErrorInvalidArgType = class extends Error {
  ...
  static {
    __name21(this, "ErrorInvalidArgType");
  }
...
__name21(validateObject, "validateObject");
...
__name21(normalizeString, "normalizeString");
function formatExt(ext) {
  return ext ? `${ext[0] === "." ? "" : "."}${ext}` : "";
}
__name(formatExt, "formatExt");
__name21(formatExt, "formatExt");
...
var format3 = platformIsWin32 ? win32.format : posix.format;
...
__name22(_validateUri, "_validateUri");
...
__name22(_schemeFix, "_schemeFix");
...
__name22(_referenceResolution, "_referenceResolution");
var _empty = "";
var _slash = "/";
var _regexp = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
var URI = class _URI {
...
__name22(isUriComponents, "isUriComponents");
...
__name22(encodeURIComponentFast, "encodeURIComponentFast");
...
__name22(encodeURIComponentMinimal, "encodeURIComponentMinimal");
...
__name22(uriToFsPath, "uriToFsPath");
...
__name22(_asFormatted, "_asFormatted");
...
__name22(decodeURIComponentGraceful, "decodeURIComponentGraceful");
...
__name22(percentDecode, "percentDecode");
...
var RemoteAuthoritiesImpl = class {
  ...
  static {
    __name23(this, "RemoteAuthoritiesImpl");
  }
  constructor() {
...
__name23(getServerProductSegment, "getServerProductSegment");
...
(function(COI2) {
  ...
  __name23(getHeadersFromQuery, "getHeadersFromQuery");
  ...
  __name23(addSearchParam, "addSearchParam");
