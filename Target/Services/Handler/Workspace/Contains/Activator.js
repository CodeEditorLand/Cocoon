...
var UriToFsPath = /* @__PURE__ */ __name((Uri) => {
...
var FolderContainsGlobViaMountain = /* @__PURE__ */ __name(async (Context, Glob) => {
...
var GetWorkspaceContainsGlobs = /* @__PURE__ */ __name((Extension) => GetActivationEvents(Extension).filter((Event) => Event.startsWith(WORKSPACE_CONTAINS_PREFIX)).map((Event) => Event.slice(WORKSPACE_CONTAINS_PREFIX.length)).filter((Glob) => Glob.length > 0), "GetWorkspaceContainsGlobs");
...
var Activator_default = ActivateWorkspaceContainsExtensions;
export {
  ActivateWorkspaceContainsExtensions,
  Activator_default as default
};
