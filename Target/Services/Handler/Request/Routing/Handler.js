...
var InferLanguageIdentifier, BuildTextDocument, DocumentVersionMap, HandleDocumentChange, HandleDocumentOpen, HandleDocumentClose, HandleDocumentSave, GetDocumentContent, Handler_default;
...
var HandleInitializeExtensionHost, HandleDeltaExtensions, HandleActivateByEvent, HandleStartExtensionHost, Handler_default2;
...
var NormalizeRange, ResolveLanguageIdentifier, BuildVsDocument, InvokeLanguageProvider, Handler_default3;
var init_Handler3 = __esm({
  "Source/Services/Handler/Language/Provider/Handler.ts"() {
    ...
    Handler_default3 = InvokeLanguageProvider;
  }
});
...
var init_Activator = __esm({
  "Source/Services/Handler/Workspace/Contains/Activator.ts"() {
    ...
    ActivateWorkspaceContainsExtensions = /* @__PURE__ */ __name(async (Context13, AddedFolders) => {
      ...
      const { default: ExtensionHostHandler } = await Promise.resolve().then(() => (init_Handler2(), Handler_exports));
...
var LazyURI, MakeUriStub, HydrateUri, ApplyWorkspaceDelta, SafeEmit, HandleSpecificNotification, Handler_default4;
        ...
        case "document.didOpen":
          ...
          if (Context13) {
            ...
            if (LanguageIdentifiers.size > 0) {
              setImmediate(() => {
                Promise.resolve().then(() => (init_Handler2(), Handler_exports)).then(({ default: ExtensionHostHandler }) => {
...
`
    ...
    Handler_default4 = HandleSpecificNotification;
  }
});
...
import { Effect as Effect9, Layer as Layer7 } from "effect";
  ...
  async "Source/Services/gRPC/Server/Service.ts"() {
    ...
    GRPCServerService = class extends EventEmitter {
        ...
        return Object.defineProperties(
          {
            ...
            ActivateByEvent: /* @__PURE__ */ __name(async (Event) => {
              await Handler_default2.HandleActivateByEvent(
      ...
      async routeRequest(method, parameters) {
        const ServiceResult = await Handler_default5(method, parameters);
        if (ServiceResult !== void 0) {
          return ServiceResult;
        }
        const Context13 = this.GetHandlerContext();
        if (method === "InitializeExtensionHost") {
          return Handler_default2.HandleInitializeExtensionHost(
            Context13,
            parameters
          );
        }
        if (method === "$deltaExtensions") {
          return Handler_default2.HandleDeltaExtensions(
            Context13,
            parameters
          );
        }
        if (method === "$activateByEvent") {
          return Handler_default2.HandleActivateByEvent(
            Context13,
            parameters
          );
        }
        if (method === "$startExtensionHost") {
          return Handler_default2.HandleStartExtensionHost(
            Context13,
            parameters
          );
        }
        if (method === "$provideTreeChildren") {
          const RequestRoutingHandler = (await Promise.resolve().then(() => (init_Handler5(), Handler_exports2))).default;
      ...
      handleMountainNotification(notification) {
        ...
        try {
          ...
          Handler_default4(
            this,
            this.documentContentCache,
            Handler_default.HandleDocumentChange,
            Handler_default.HandleDocumentOpen,
            Handler_default.HandleDocumentClose,
            Handler_default.HandleDocumentSave,
            notification.Method,
            parameters,
      ...
      GetDocumentContent(Uri) {
        return Handler_default.GetDocumentContent(
          this.documentContentCache,
          Uri
        );
      }
    ...
    GRPCServerServiceLayer = Layer7.effect(
      IGRPCServerService,
      Effect9.sync(() => new GRPCServerService())
    );
    GRPCServerServiceLive = Layer7.effect(
      IGRPCServerService,
      Effect9.sync(() => new GRPCServerService())
    );
  }
...
import { Context as Context7, Effect as Effect10, Layer as Layer8, Ref as Ref5, SubscriptionRef as SubscriptionRef5 } from "effect";
...
var init_RPCServer = __esm({
  async "Source/Effect/RPCServer.ts"() {
    ...
    RPCServerTag = class extends Context7.Tag("Cocoon/RPCServer")() {
      static {
        __name(this, "RPCServerTag");
      }
    };
    RPCServer = RPCServerTag;
    RPCServerLive = Layer8.effect(
      RPCServer,
...
import { Context as Context8, Duration, Effect as Effect11, Layer as Layer9, Schedule as Schedule2 } from "effect";
...
var init_Bootstrap = __esm({
  async "Source/Effect/Bootstrap.ts"() {
    ...
    BootstrapTag = class extends Context8.Tag("Cocoon/Bootstrap")() {
      static {
...
import { Layer as Layer10 } from "effect";
var EffectServices;
  ...
  async "Source/Service/Mapping.ts"() {
    ...
    EffectServices = {
      ...
      composeAppLayer: /* @__PURE__ */ __name(() => {
        ...
        const Layer1 = Layer10.mergeAll(
          HealthLive.pipe(Layer10.provide(Telemetry2)),
          MountainClientLive.pipe(Layer10.provide(Telemetry2)),
          ModuleInterceptorLive.pipe(Layer10.provide(Telemetry2)),
          ExtensionLive.pipe(Layer10.provide(Telemetry2)),
          RPCServerLive.pipe(Layer10.provide(Telemetry2))
        );
        const Bootstrap = BootstrapLive.pipe(
          Layer10.provide(Telemetry2),
          Layer10.provide(Layer1)
        );
        return Layer10.mergeAll(Telemetry2, Layer1, Bootstrap);
      }, "composeAppLayer"),
      /**
...
var init_Service5 = __esm({
  "Source/Interfaces/I/Extension/Host/Service.ts"() {
    "use strict";
    IExtensionHostService = Context9.Tag(
...
var init_Service6 = __esm({
  "Source/Interfaces/I/Configuration/Service.ts"() {
    ...
    IConfigurationService = Context10.Tag(
...
import { Context as Context11 } from "effect";
var IPerformanceMonitoringService;
var init_Service7 = __esm({
  "Source/Interfaces/I/Performance/Monitoring/Service.ts"() {
    "use strict";
    IPerformanceMonitoringService = Context11.Tag("IPerformanceMonitoringService");
  }
});
...
var init_Service8 = __esm({
  "Source/Interfaces/I/Security/Service.ts"() {
    "use strict";
    ISecurityService = Context12.Tag("ISecurityService");
  }
});
...
var RouteRequest, Handler_default5;
    ...
    RouteRequest = /* @__PURE__ */ __name(async (Method, Parameters) => {
      ...
      const RoutePatterns = {
        "extension.\\w+": /* @__PURE__ */ __name(async (Method2, Params) => {
          ...
          const { IExtensionHostService: IExtensionHostService2 } = await Promise.resolve().then(() => (init_Service5(), Service_exports2));
          switch (Method2) {
        ...
        "configuration.\\w+": /* @__PURE__ */ __name(async (Method2, Params) => {
          const { ServiceMapping } = await init_Mapping().then(() => Mapping_exports);
          const { IConfigurationService: IConfigurationService2 } = await Promise.resolve().then(() => (init_Service6(), Service_exports3));
          switch (Method2) {
...
`
        ...
        "performance.\\w+": /* @__PURE__ */ __name(async (Method2, _Params) => {
          const { ServiceMapping } = await init_Mapping().then(() => Mapping_exports);
          const { IPerformanceMonitoringService: IPerformanceMonitoringService2 } = await Promise.resolve().then(() => (init_Service7(), Service_exports4));
          switch (Method2) {
        ...
        "security.\\w+": /* @__PURE__ */ __name(async (Method2, Params) => {
          const { ServiceMapping } = await init_Mapping().then(() => Mapping_exports);
          const { ISecurityService: ISecurityService2 } = await Promise.resolve().then(() => (init_Service8(), Service_exports5));
          switch (Method2) {
    ...
    Handler_default5 = RouteRequest;
  }
});
init_Handler5();
export {
  Handler_default5 as default
};
