...
var WrapEnvNamespace = /* @__PURE__ */ __name((Concrete) => Heuristics_default("env", Concrete), "WrapEnvNamespace");
var Namespace_default = WrapEnvNamespace;
...
var CreateEnvNamespace = /* @__PURE__ */ __name((Context) => {
  ...
  const NormalizeAppRoot = /* @__PURE__ */ __name((Raw) => {
    ...
    if (!Raw.startsWith("file:")) {
      Log_default.Info("EnvNs", `appRoot already plain path: ${Raw}`);
      return Raw;
    }
    try {
...
var Namespace_default2 = CreateEnvNamespace;
export {
