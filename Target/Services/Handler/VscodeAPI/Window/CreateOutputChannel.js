var s=(t,o,u,r)=>{const i=typeof r=="object"&&r!==null?r.log===!0:!1;t.SendToMountain("outputChannel.create",{handle:o,name:u,log:i}).catch(()=>{});const e=n=>{t.SendToMountain("outputChannel.append",{handle:o,name:u,value:n}).catch(()=>{})};return{name:u,append:e,appendLine:n=>e(`${n}
...
`),info:(n,...a)=>e(`[info] ${n}
`),warn:(n,...a)=>e(`[warn] ${n}
`),error:(n,...a)=>{const l=n instanceof Error?n.stack??n.message:String(n);e(`[error] ${l}
`)}}};export{s as default};
