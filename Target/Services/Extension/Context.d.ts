...
export declare class Memento {
    ...
    readonly _MountainClient: IMountainClientService | undefined;
    constructor(Storage: Map<string, unknown>, ExtensionId: string, Logger: Logger, MountainClient?: IMountainClientService);
    /**
...
export declare class ExtensionSecretStorage {
    ...
    constructor(ExtensionId: string, Logger: Logger, MountainClient?: IMountainClientService | null);
    /**
