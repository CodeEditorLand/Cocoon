...
export declare const EffectServices: {
     ...
     */
    composeAppLayer: () => Layer.Layer<import("./Effect/RPCServer.js").RPCServerTag | import("./Effect/Telemetry.js").TelemetryTag | import("./Effect/Bootstrap.js").BootstrapTag | import("./Effect/MountainClient.js").MountainClientTag | import("./Effect/ModuleInterceptor.js").ModuleInterceptorTag | import("./Effect/Extension.js").ExtensionTag | import("./Effect/Health.js").HealthTag, never, never>;
    /**
    ...
    getMountainClient: () => Layer.Layer<import("./Effect/MountainClient.js").MountainClientTag, never, import("./Effect/Telemetry.js").TelemetryTag>;
    getModuleInterceptor: () => Layer.Layer<import("./Effect/ModuleInterceptor.js").ModuleInterceptorTag, never, import("./Effect/Telemetry.js").TelemetryTag>;
