...
const FromAPI = /* @__PURE__ */ __name((From, EntryID, CommandConverter) => {
  return {
    ...
    backgroundColor: From.backgroundColor instanceof ExtHostTypes.ThemeColor ? From.backgroundColor.id : void 0,
    color: typeof From.color === "string" ? From.color : From.color instanceof ExtHostTypes.ThemeColor ? From.color.id : void 0,
