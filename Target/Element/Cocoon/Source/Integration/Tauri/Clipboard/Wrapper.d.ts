...
export declare const WriteText: (Text: string) => Effect.Effect<void, never>;
export declare const ReadText: Effect.Effect<string, IntegrationClipboardProblem>;
export declare const WriteResourceList: (ResourceList: (typeof URI)[]) => Effect.Effect<void, IntegrationClipboardProblem>;
...
export declare const ReadImage: Effect.Effect<Uint8Array, IntegrationClipboardProblem>;
