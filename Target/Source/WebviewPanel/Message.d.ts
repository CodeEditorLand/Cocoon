 ...
 */
export type MessageHandler = (Message: WebViewMessage) => Effect.Effect<void, Error>;
/**
...
export interface MessageRouter {
    ...
    readonly RegisterHandler: (Type: string, Handler: MessageHandler) => Effect.Effect<void, never>;
    readonly UnregisterHandler: (Type: string) => Effect.Effect<void, never>;
}
declare const MessageService_base: Effect.Service.Class<MessageService, "Message/WebViewPanel", {
    readonly effect: Effect.Effect<{
        CreateMessage: (Type: "Request" | "Response" | "Event", Payload: unknown) => WebViewMessage;
        SendMessage: (WebView: VSCodeWebview, Message: WebViewMessage) => Effect.Effect<boolean, never>;
        RegisterHandler: (Type: string, Handler: MessageHandler) => Effect.Effect<void, never>;
        UnregisterHandler: (Type: string) => Effect.Effect<void, never>;
        Handle: (Message: unknown) => Effect.Effect<void, Error>;
    }, unknown, never>;
}>;
/**
