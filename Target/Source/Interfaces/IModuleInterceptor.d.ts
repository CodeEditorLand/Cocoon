...
export interface IModuleInterceptor {
     ...
     */
    interceptRequire(request: ModuleInterceptionRequest): Promise<ModuleInterceptionResult>;
    /**
 ...
 */
export declare const IModuleInterceptor: any;
//# sourceMappingURL=IModuleInterceptor.d.ts.map