 ...
 */
export declare class TreeViewImplementation<T> implements VSCodeTreeView<T> {
...
declare const TreeViewService_base: Effect.Service.Class<TreeViewService, "Service/TreeView", {
    readonly effect: Effect.Effect<{
        CreateTreeView: <T>(ViewId: string, Options: TreeViewOptions<T>, Extension: IExtensionDescription) => Effect.Effect<TreeViewImplementation<T>, IPCProblem, never>;
    }, never, IPCService>;
}>;
/**
 * @class TreeView
