...
export declare const ProcessShim: {
    ...
    listenerCount<E extends string | symbol>(eventName: string | symbol, listener?: (...args: any[]) => void): number;
    ...
    removeAllListeners<E extends string | symbol>(eventName?: string | symbol): ProcessShimBase;
